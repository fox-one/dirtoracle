...
var rootCmd = &cobra.Command{
	Use:   "dirtoracle-example",
	Short: "dirt oracle usage example",
}
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.oracleexample.yaml)")
...
func initConfig() {
	...
	if cfgFile == "" {
		...
		filename := path.Join(dir, ".oracleexample.yaml")
