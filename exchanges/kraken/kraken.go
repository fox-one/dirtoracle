...
type krakenEx struct{}

func New() exchange.Interface {
	return &krakenEx{}
}

func (c *krakenEx) Name() string {
	return exchangeName
}

func (c *krakenEx) Subscribe(ctx context.Context, a *core.Asset, h exchange.Handler) error {
...
func (*krakenEx) assetSymbol(symbol string) string {
	return symbol
}

func (*krakenEx) pairSymbol(symbol string) string {
	return symbol + "USD"
}
